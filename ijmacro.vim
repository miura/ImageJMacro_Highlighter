...
syn keyword ijmacroFunctionDot	contained Array concat copy getStatistics invert sort fill print rankPositions reverse slice trim 
syn keyword ijmacroFunctionDot	contained Dialog create addMessage addString addNumber addCheckbox addCheckboxGroup addChoice addHelp show getString getNumber getCheckbox getChoice setInsets
syn keyword ijmacroFunctionDot	contained File name directory openDialog openUrlAsString length separator isDirectory append exists rename open openAsString nameWithoutExtension lastModified delete openAsRawString makeDirectory dateLastModified getName getParent close separator saveString openAsString 
syn keyword ijmacroFunctionDot	contained Fit nEquations rSquared getEquation doFit showDialog plot logResults nParams p f
syn keyword ijmacroFunctionDot	contained IJ currentMemory deleteRows freeMemory redirectErrorMessages maxMemory getToolName log pad renameResults
...
syn keyword ijmacroFunctionDot	contained Stack setActiveChannels setChannel setSlice getPosition setFrameRate isHyperstack setZUnit setPosition getDisplayMode getFrameRate setDimensions getDimensions getStatistics setTUnit swap setDisplayMode setFrame getFrameInterval setFrameInterval getActiveChannels 
syn keyword ijmacroFunctionDot	contained String paste append resetBuffer buffer copy copyResults getResultsHeadings
syn keyword ijmacroFunctionDot contained Plot create setLimits setFrameSize setLineWidth setColor addText setJustification drawLine show update getValues  
syn keyword ijmacroFunctionDot	contained Ext
